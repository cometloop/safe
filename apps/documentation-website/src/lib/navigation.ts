export const navigation = [
  ...
  },
  {
    title: 'Advanced',
    links: [
      { title: 'Retry support', href: '/docs/retry-support' },
      { title: 'Timeout / Abort', href: '/docs/timeout-abort' },
    ],
  },
  {
    title: 'Reference',
    links: [
      ...
      { title: 'Error mapping patterns', href: '/docs/error-mapping' },
      { title: 'Result transformation', href: '/docs/result-transformation' },
    ],
  },
  {
    title: 'Examples',
